...
**Hệ thống quản lý Thực tập sinh** là một hệ thống thông tin hỗ trợ quá trình tổ chức và quản lý thực tập cho sinh viên, giảng viên, cơ sở thực tập và các đơn vị liên quan.

Hệ thống được xây dựng nhằm tập trung hóa dữ liệu, kiểm soát quá trình thực tập và hỗ trợ công tác theo dõi, đánh giá và báo cáo kết quả thực tập trong một môi trường thống nhất.
...
Trong quá trình tổ chức thực tập sinh, các đơn vị quản lý thường phải xử lý nhiều loại thông tin liên quan đến sinh viên, đợt thực tập, địa điểm thực tập, người hướng dẫn, tiến độ công việc và kết quả đánh giá.

Nếu dữ liệu được quản lý rời rạc, theo cách thủ công hoặc phân tán trên nhiều nguồn khác nhau, sẽ dễ phát sinh các vấn đề như:
...
Hệ thống quản lý Thực tập sinh được xây dựng để giải quyết các vấn đề trên bằng cách tạo ra một nền tảng quản lý tập trung, cho phép các bên liên quan cập nhật, tra cứu và theo dõi thông tin một cách có hệ thống.
...
Các mục tiêu trên được xác định dựa trên phạm vi chức năng thể hiện trong Product Backlog. Những nội dung chưa có cơ sở rõ ràng trong backlog không được suy diễn thành chức năng chính của hệ thống.
...
Các chức năng thuộc phạm vi của hệ thống được xác định từ Product Backlog, bao gồm:
...
Các nội dung trên chưa được xác định là một phần của hệ thống trong phạm vi hiện tại và do đó không được đưa vào phần chức năng chính của dự án.

---

## 6. Các chức năng chính

Hệ thống quản lý Thực tập sinh được nhóm thành các module chính như sau:
...
- Đánh giá năng lực và hiệu quả thực tập.
...
Quy trình quản lý thực tập sinh được tổ chức theo các giai đoạn:

**Đăng ký → Quản lý hồ sơ → Phân công → Thực tập → Theo dõi tiến độ → Đánh giá → Báo cáo kết quả**

Quy trình giúp các bên liên quan có thể theo dõi xuyên suốt quá trình thực tập và cập nhật trạng thái tại từng giai đoạn.

---

## 8. Quản lý dự án

Dự án được quản lý theo phương pháp **Agile/Scrum**.

Các thành phần quản lý công việc bao gồm:
...
| **Jira** | Quản lý Product Backlog, Sprint và công việc |

---

## 9. Kết luận

**Hệ thống quản lý Thực tập sinh** là một hệ thống nghiệp vụ hỗ trợ quản lý toàn bộ quy trình thực tập của sinh viên từ khi tham gia, theo dõi, đánh giá đến báo cáo kết quả.

Hệ thống tập trung giải quyết các vấn đề về:
...
Với các actor chính gồm **sinh viên, giảng viên, người hướng dẫn, đơn vị thực tập và quản trị viên**, hệ thống hướng tới việc tạo ra một môi trường quản lý thực tập tập trung, minh bạch và thuận tiện cho các bên liên quan.
